# Note: taken from https://github.com/laitathei/YOLOv8-ONNX-RKNN-HORIZON-TensorRT-Detection/blob/main/utils.py
...
def vis_result(image_3c, results, colorlist, CLASSES, result_path):
    ...
    for i, box in enumerate(boxes):
        ...
        cv2.putText(vis_img, f"{CLASSES[cls]}:{round(box[4], 2)}", (int(box[0]), int(box[1])), cv2.FONT_HERSHEY_SIMPLEX,
                    1, (0, 255, 0), 2)
